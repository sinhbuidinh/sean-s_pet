                            ...
                            <form role="form" method="POST" id="paymentForm" action="{{ url('/payment')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="gateway">
                                        <option value="">---</option>
                                        @foreach($gateways as $gatewayEnum => $paymentName)
                                            <option value="{{$gatewayEnum}}">{{$paymentName}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="amount" placeholder="Amount charge">
                                </div>
